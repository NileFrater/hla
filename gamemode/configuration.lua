...
CAKE.ConVars[ "DefaultTime" ] = "1 1 2027 1" --The initial time of the script's clock.
...
CAKE.ConVars[ "UseEnhancedCitizens" ] = true --Set this to false if you want to use the default models instead of Enhanced Citizens by Bloocobalt and Lt_Commander.
...
CAKE.ConVars[ "DefaultTitle2" ] = "Citizen Extended Description" -- The default extended description
...
CAKE.ConVars[ "IntroText" ] = "Half-Life: Aftermath" -- Character menu and intro text. NOTE, the HL2RP scheme changes this
...
CAKE.ConVars[ "MenuTitle" ] = "Half-Life: Aftermath" --Title for the main menu

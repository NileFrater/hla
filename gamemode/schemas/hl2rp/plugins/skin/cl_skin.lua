...
function SKIN:PaintIntro()
	...
	draw.SimpleTextOutlined( "HALF-LIFE: AFTERMATH", "TiramisuHL2RPFont1", ScrW()/2 + math.random(-10,10), ScrH() /2 + math.random(-10,10), Color(100,100,100,CAKE.IntroStage2Alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_LEFT, 1, Color(0,0,0,math.max(CAKE.IntroStage2Alpha, 130)))
	draw.SimpleTextOutlined( "HALF-LIFE: AFTERMATH", "TiramisuHL2RPFont1", ScrW()/2, ScrH() /2, Color(255,255,255,CAKE.IntroStage2Alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_LEFT, 1, Color(0,0,0,math.max(CAKE.IntroStage2Alpha, 130)))
